...
HD_PWD='C:/Users/Admin/Documents/Vivado/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pong_top_an.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pong_top_an.tcl -notrace
