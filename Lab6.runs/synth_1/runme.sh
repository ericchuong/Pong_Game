...
HD_PWD='C:/Users/Admin/Documents/Vivado/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pong_top_an.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pong_top_an.tcl
